            ...
            <div className="px-8 pt-12 pb-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="block w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50/50 focus:bg-white" 
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-600">
                  ...
                  <a href="/bsignup" className="font-medium text-blue-600 hover:text-blue-800 transition">
                    Sign up
                  </a>
                </p>
              </div>
